...
-keep class com.daquv.hub.data.model.** { *; }
-keep class com.daquv.hub.domain.** { *; }
-keep class com.daquv.hub.presentation.conf.** { *; }
-keep class com.daquv.hub.presentation.webview.** { *; }
-keep class com.daquv.smart.jex.** { *; }
-keep class com.daquv.smart.g_sdk_android.** { *; }
-keep class com.kt.gigagenie.** { *; }
