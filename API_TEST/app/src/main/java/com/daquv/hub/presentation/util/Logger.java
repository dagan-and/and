...
public class Logger {
    ...
    // 로그 태그
    /** 개발용 로그 태그 */
    private static final String TAG_DEV         = "DAQUV_DEV";
    /** 정보성 로그 태그 */
    private static final String TAG_INFO        = "DAQUV_INFO";
    /** 에러 로그 태그 */
    private static final String TAG_ERR         = "DAQUVH_ERR";
    /** 웹 로그 태그 */
    private static final String TAG_WEB         = "DAQUVH_WEB";
    ...
    **/
     ...
     * 로그 출력 Level 설정
     * <br><br>
     * - 로그 출력 여부가 '미출력 (false)' 로 설정되어 있는 경우 무시 <br>
